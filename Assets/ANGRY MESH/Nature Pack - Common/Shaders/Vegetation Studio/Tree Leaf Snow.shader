...
Shader "ANGRYMESH/Nature Pack/Vegetation Studio/Tree Leaf Snow"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half temp_output_99_0_g124 = ( 1.0 * AGW_WindScale );
			half temp_output_101_0_g124 = ( 1.0 * AGW_WindSpeed );
			half mulTime10_g124 = _Time.y * temp_output_101_0_g124;
			half temp_output_73_0_g124 = ( AGW_WindToggle * _WindTrunkAmplitude * AGW_WindAmplitude );
			half VColor_Red1622 = v.color.r;
			half temp_output_1428_0 = pow( abs( VColor_Red1622 ) , _WindTrunkStiffness );
			half temp_output_48_0_g124 = temp_output_1428_0;
			half temp_output_28_0_g124 = ( ( sin( ( ( ase_worldPos.z * temp_output_99_0_g124 ) + ( ( temp_output_101_0_g124 * _SinTime.z ) + mulTime10_g124 ) ) ) * temp_output_73_0_g124 ) * temp_output_48_0_g124 );
			half temp_output_49_0_g124 = 0.0;
			half3 appendResult63_g124 = (half3(temp_output_28_0_g124 , ( ( sin( ( ( temp_output_99_0_g124 * ase_worldPos.y ) + mulTime10_g124 ) ) * temp_output_73_0_g124 ) * temp_output_49_0_g124 ) , temp_output_28_0_g124));
			...
			half2 appendResult8_g122 = (half2(ase_worldPos.x , ase_worldPos.z));
			half4 lerpResult17_g122 = lerp( _TintColor1 , _TintColor2 , saturate( ( tex2Dlod( AG_TintNoiseTexture, float4( ( appendResult8_g122 * ( 0.001 * AG_TintNoiseTile * _TintNoiseTile ) ), 0, 0.0) ).r * (0.001 + (AG_TintNoiseContrast - 0.001) * (60.0 - 0.001) / (10.0 - 0.001)) ) ));
			half4 lerpResult19_g122 = lerp( temp_cast_2 , lerpResult17_g122 , AG_TintToggle);
			o.vertexToFrag18_g122 = lerpResult19_g122;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			half3 break105_g126 = lerpResult158;
			half switchResult107_g126 = (((i.ASEVFace>0)?(break105_g126.z):(-break105_g126.z)));
			half3 appendResult108_g126 = (half3(break105_g126.x , break105_g126.y , switchResult107_g126));
			half3 normalizeResult136 = normalize( appendResult108_g126 );
			...
			half4 TintColor1462 = i.vertexToFrag18_g122;
			...
			half lerpResult14_g127 = lerp( 0.0 , AG_TranslucencyIntensity , saturate( ( ( 1.0 - (0.0 + (distance( ase_worldPos , _WorldSpaceCameraPos ) - 0.0) * (1.0 - 0.0) / (AG_TranslucencyDistance - 0.0)) ) * VColor_Alpha1626 ) ));
			half Output_Transluncency1126 = lerpResult14_g127;
...
/*ASEBEGIN
Version=18504
1927;7;1906;1005;6647.226;2645.625;3.727124;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;364;-4480,-640;Float;False;Property;_EnableWorldProjection;Enable World Projection;36;0;Create;True;0;0;False;1;Header(Projection);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1660;-4864,128;Inherit;False;AG Global Tint Color;0;;122;1dcc860732522ee469468f952b4e8aa1;0;3;27;COLOR;0,0,0,0;False;28;COLOR;0,0,0,0;False;22;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1656;-3968,1280;Inherit;False;AG Global Wind - Tree;-1;;124;b3a3869a2b12ed246ae10bcce7d41e6e;0;6;48;FLOAT;0;False;49;FLOAT;0;False;96;FLOAT;1;False;94;FLOAT;1;False;95;FLOAT;1;False;97;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;914;-5248,-1888;Half;False;Global;AG_TreesAO;AG_TreesAO;21;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1662;-1408,-640;Inherit;False;AG Flip Normals;-1;;126;02ae90bb716acd647b8ac9db8603316a;0;1;110;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1653;-2560,128;Inherit;False;AG Global Transluncency;-1;;127;478210ebafb74104ba79a094e66bfe96;0;1;15;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=65359C2CEE9AB8949AC7EDA3BB1ED35B3677A9A4